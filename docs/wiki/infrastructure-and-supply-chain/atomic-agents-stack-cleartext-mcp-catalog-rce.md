...
- Confidence: high for affected range and patch target from the GitHub advisory; lower for exact mitigation semantics until release notes are inspected in detail.
