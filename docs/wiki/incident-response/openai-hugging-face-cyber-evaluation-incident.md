...
Containment guidance is provisional while investigation continues: [cyber-evaluation containment](../testing-and-assurance/cyber-evaluation-containment.md) covers release-gate and sandbox controls, [agent network egress controls](../agent-and-tool-security/agent-network-egress-controls.md) covers network and package-proxy reachability, and [defender model access during security incidents](defender-model-access-during-security-incidents.md) covers controlled use of capable models during response.
...
- Added from the July 22, 2026 raw collector artifact; keep future updates focused on incident mechanics and AI security controls.
