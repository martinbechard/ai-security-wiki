...
The [September 13 topic collector source](../../../raw/processed/2026-09-13/ai-security-wiki-topic-news-collector-2026-09-13T171540Z.json) records sampled IBM Langflow OSS 1.0.0 through 1.11.5 CVEs where scanner or code-validation controls fail before execution. Broad Langflow product context belongs upstream; this page owns the static-scanner and interpreter-sink boundary.
...
- Affected boundary: IBM Langflow OSS 1.0.0 through 1.11.5 for the sampled scanner/eval records; some related variants report 1.0.0 through 1.10.3.
