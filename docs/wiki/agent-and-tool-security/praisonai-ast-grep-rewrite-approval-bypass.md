...
The [August 26 leaf update watch source](../../../raw/processed/2026-08-26/ai-security-wiki-leaf-update-watch-20260827T000538Z.json) resolves CVE-2026-55530 to [GHSA-cfxv-8fw8-rwpv](https://github.com/MervinPraison/PraisonAI/security/advisories/GHSA-cfxv-8fw8-rwpv), where `ast_grep_rewrite` missed the `@require_approval` guard and was fixed in `praisonaiagents` 1.6.58. Broad PraisonAI framework context belongs upstream; this page owns the local file-mutation approval boundary.
