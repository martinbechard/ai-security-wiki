...
- [September 22 leaf update watch source](../../../raw/processed/2026-09-22/ai-security-wiki-leaf-update-watch-20260923T000353Z.json)
...
- [September 23 leaf update watch source](../../../raw/processed/2026-09-23/ai-security-wiki-leaf-update-watch-20260924T000331Z.json)
...
- Updated on 2026-09-06 with item-level September entries for Bifrost plugin loading, JeecgBoot Airag access control, Axolotl multipack remote-code loading, Copilot Studio signature verification, OpenAI wiki-incident disclosure, Cloud Monitoring MCP controls, and Anthropic cyber-evaluation remediation follow-up; entries remain reverse chronological and are not grouped by raw artifact, collector run, sweep category, or ingest batch.
- Updated on 2026-09-07 with item-level September entries for knowns MCP path traversal, OpenShift AI NIM Secret exposure, GPTQModel Triton OOB read, Igniter terminal prompt forgery, and [SureForms AI Forms stored XSS](../data-and-privacy/sureforms-ai-forms-stored-xss.md); entries remain reverse chronological and are not grouped by raw artifact, collector run, sweep category, or ingest batch.
- Updated on 2026-09-08 with item-level September entries for focused Open WebUI and Flowise advisory families plus Agno, llmware, PraisonAI, and ASCII smuggling; entries remain reverse chronological and are not grouped by raw artifact, collector run, sweep category, or ingest batch.
- Updated on 2026-09-13 with item-level September entries for Anthropic threat intelligence, OmniRoute, knowns, split IBM Langflow and ContextForge issues, Flowise, WPBot, n8n, Cheshire Cat AI, MCPHub, and RubyGems; entries remain reverse chronological and are not grouped by raw artifact, collector run, sweep category, or ingest batch.
- Updated on 2026-09-16 with item-level September entries for Docker MCP Gateway image-label argument injection, mcp-searxng SSRF, Flowise MongoDBMemory session leakage, and [UK frontier AI oversight](../governance-and-compliance/uk-frontier-ai-oversight.md); watcher metadata remained leaf-level unless it changed the item-level current understanding.
...
- Updated on 2026-09-23 with item-level September entries for 9Router, FastGPT, vLLM NIXL/Mooncake, and split MCP Atlassian advisory boundaries; ordering remains reverse chronological and not grouped by raw artifact, collector run, sweep category, or ingest batch.
- Updated on 2026-09-24 with item-level September 23 digest entries and September 23 watcher provenance; digest entries remain reverse chronological and not grouped by raw artifact, collector run, sweep category, or ingest batch.
