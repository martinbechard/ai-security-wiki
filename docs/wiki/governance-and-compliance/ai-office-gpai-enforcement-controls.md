---
type: "Topic"
title: "AI Office GPAI Enforcement Controls"
description: "Security-governance lens for European Commission AI Office enforcement powers over advanced GPAI models."
tags: ["governance-and-compliance", "testing-and-assurance"]
---

# AI Office GPAI Enforcement Controls

## Current Understanding

AI Office GPAI enforcement controls are the response and evidence controls needed when the European Commission AI Office uses its powers for the most advanced GPAI models. The [August 10 leaf update watch source](../../../raw/processed/2026-08-09/ai-security-wiki-leaf-update-watch-20260810T000240Z.json) records the [AI Act Service Desk FAQ](https://ai-act-service-desk.ec.europa.eu/en/faq?faq_category_id=69) as evidence that these powers apply from 2026-08-02. The fetched FAQ did not expose a page-level update timestamp, so this page treats 2026-08-02 as an effective enforcement date rather than a publication date.
...
- Residual risk: exact AI Office evidence expectations, model-access mechanics, market-restriction triggers, and provider/deployer responsibility split remain implementation-specific.

## Control Implications

- Maintain a GPAI dependency inventory that names provider, model version, deployment role, systemic-risk classification, and local owner.
...
- Upstream AI wiki owns broad EU AI Act, GPAI, provider, and model context.
